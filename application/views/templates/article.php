      ...
      <div class="article-container Grid AppContainer">
        <div class="PageContent Grid_Column size-75">
          <div class="PageContentHeader header">
            <?php if($article->pre_head != "") { ?>
              <h4><?php echo $article->pre_head; ?></h4>
            <?php } ?>
            ...
            <span class="footer-left date"><?php echo e($article->pubdate) ?> | 4:30PM </span>
          ...
          <div class="PageContentBody">
            ...
            <strong>- <?php if ($article->tagline == 'PCIJ,') { echo $article->tagline . " " . $date; }
              else { echo $article->tagline . " ";
              $i = 0;
            ...
            <div class="NormalBlock">
              <div class="BrowseContent">
                ...
                <div class="BrowseBody Grid">
                  <?php foreach ($recent_news as $num =>  $article) { if ($num < 3) {?>
                  <div class="Grid_Column col-3">
                    <div class="Story">
                      ...
                      <div class="StoryFooter">
                        <a class="footer-left" href="<?php echo get_link($article, 'article') ?>">READ MORE</a>
                      </div>
                    </div>
                  </div>
                  <?php } } ?>
